  ...
  <>
    <Card.Root maxW="sm" gap={0} overflow="hidden">
        ...
        <Card.Header pt={4} px={4}>
          <Card.Title textOverflow="ellipsis" whiteSpace="nowrap" width="100%" overflow="hidden"title="lockdown.solv">{props.title}<br></br> <Badge variant="surface">{props.tag}</Badge></Card.Title>
        </Card.Header>
