import { Stack, Heading, HStack, Box, Text, Grid, GridItem, Editable, IconButton, Avatar, Select, AbsoluteCenter, createListCollection, useSelectContext,  } from "@chakra-ui/react"
    ...
    <form action="">
        <Stack className="app-page" gap="8" w="100%">
            ...
            <Box border="3px solid" borderColor="border" borderRadius="md" pe="10" px='8' py="8" minH={"300px"}>
              <Grid className="energy-container-grid" templateColumns="repeat(12, 5fr)" gap="8" h="100%">
                <GridItem className="energy-container-puzzle-col" colSpan={5} display="flex" flexDirection='column' gap={2}>
                  <Box>
                ...
                <GridItem className="energy-container-puzzle-col" colSpan={4} display="flex" flexDirection='column' gap={2}>
                  <HStack>
                ...
                <GridItem className="energy-container-puzzle-col" colSpan={3} display="flex" flexDirection='column' gap={2}>
                  <HStack>
                ...
                <HStack justifyContent="center">
                  {[0, 1, 2, 3, 4, 5, 6].map((index) => (
                      <Box 
                        ...
                        fontWeight="normal"
                      >
                        <AbsoluteCenter>{colorblindIndexes[colorSequence[index]] || ''}</AbsoluteCenter>
                      </Box>
                    ))}
                </HStack>
        </Stack>
