...
const GreetingsText = () => (
  <>
      ...
      <Text fontSize="sm">This directory was developed with the goal of offering a high-quality and efficient website, centralizing all The Experiment Solvers in a single location. User experience (UX) was prioritized to ensure practicality and ease of interaction, taking into account the most efficient ways of use.</Text>
...
const Changelog = () => (
  <>
      ...
      <Heading size="xl">18th February 2026 — Changelog <Badge>v4.0</Badge></Heading>
      <Text fontSize="sm">These are the recent additions and changes to the directory:</Text>
      <List.Root ps={6}>
        <List.Item fontSize="sm">New solver <b>batteries-puzzle.solv</b> available;</List.Item>
        <List.Item fontSize="sm">Added a <b>color mode</b> button to change website theme;</List.Item>
        <List.Item fontSize="sm">Expanded Website's container area;</List.Item>
...
function App() {
  return (
    <Box className="app-page" display="flex" flexDirection="column" gap={4}>
