...
const Changelog = () => (
  <>
    ...
    <Heading size="xl">09th July 2026 — Changelog <Badge>v6.1</Badge></Heading>
    ...
    <List.Root ps={6}>
      <List.Item fontSize="sm">New solver available <b>Timeless: Grid</b>.</List.Item>
            <List.Item fontSize="sm">Minor bug fixes and changes.</List.Item>>      <List.Item fontSize="sm">Minor bug fixes and changes.</List.Item>      <List.Item fontSize="sm">Minor bug fixes and changes.</List.Item>
    </List.Root>
  </>
)
